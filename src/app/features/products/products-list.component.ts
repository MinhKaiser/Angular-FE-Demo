                ...
                @for (item of store.paginationItems(); track trackPaginationItem(item)) {
                  @if (item.kind === 'page') {
                    <button
                      type="button"
                      class="products-pagination__button"
                      [class.products-pagination__button--active]="item.value === store.currentPage()"
                    ...
                    <span class="products-pagination__ellipsis" aria-hidden="true">
                      ...
                    </span>
                  }
                }
...
export class ProductsListComponent implements OnInit {
  ...
  protected trackPaginationItem(item: { kind: 'page'; value: number } | { kind: 'ellipsis'; key: string }): string {
